...
class KLineViewer:
    ...
    def __init__(self, stock_code="601398", start_date="20260101", end_date="20260401", 
                 target_date=None, display_days=30):
        """
        初始化K线查看器
    ...
    def show(self):
        ...
        if self.target_date:
            print(f"\n当前定位: {self.df.iloc[initial_highlight_idx]['Date'].strftime('%Y-%m-%d')}")
